...
public abstract class SlideBox extends BaseBox {
	private static final String TAG = SlideBox.class.getSimpleName();
	...
	public SlideBox(Service service) {
		mService = service;
		mContext = service;
		...
		mDialog = (FloatingViewGroup) LayoutInflater.from(mContext).inflate(R.layout.slidedialog_layout, null);

		mHeight = Utils.dp2px(mContext, 200 + Utils.fontSize * 5);
